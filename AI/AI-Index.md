...
3. [Project-Methodology.md](../Docs/Project-Methodology.md)
...
- `Project-Status.md` — current stage, objective, active work, blockers and next milestone
- `Project-Changelog.md` — project change history
- `Docs/Project-Architecture.md` — current approved system architecture
- `Docs/Project-Methodology.md` — engineering methodology and project standards
