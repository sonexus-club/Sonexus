...
| ADR-005 | Gateway Architecture | 1.0 | Final | Completed | Published | S-1 — HDS Gateway Express | — | Command Layer architecture passed Engineering Review; implementation is pending |
