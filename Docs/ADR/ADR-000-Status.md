...
| ADR-005 | Gateway Architecture | — | Planned | In Progress | Not Created | S-1 — HDS Gateway Express | — | Gateway Command Layer analysis is active; no ADR document exists yet |
